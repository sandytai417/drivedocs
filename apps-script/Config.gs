...
var CONFIG = {
  ...
  /**
   * Drive 路徑規則（固定）
   * 客戶：我的雲端硬碟／千婷-整理客戶資料／{注音}／{客戶姓名}／{資料日期}
   * 例：我的雲端硬碟／千婷-整理客戶資料／ㄉ／戴**／1150813
   * 活動：我的雲端硬碟／千婷-上傳本週115年活動／{N}月活動／{Y}年{M}月第W週活動
   */
  DRIVE_PATHS: {
  ...
  DEFAULT_ROOT_NAME: '千婷-整理客戶資料',
  LEGACY_ROOT_NAME: '客戶資料',
  ACTIVITY_ROOT_NAME: '千婷-上傳本週115年活動',
  SUPPORTED_MIME: {
